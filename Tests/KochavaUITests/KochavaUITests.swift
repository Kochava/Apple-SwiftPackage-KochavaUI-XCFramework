...
final class KochavaUITests: XCTestCase
{
    ...
    func test_witnessAllKnownProductRegistrationLogMessages()
    {
        ...
        // TEST
        // Log.shared.level
        // ⓘ Set to trace.  This will result in the KochavaNetworking.Product being registered, and this will be prefaced by any other known modules which are included.  This will be printed to the log where they can be inspected.
